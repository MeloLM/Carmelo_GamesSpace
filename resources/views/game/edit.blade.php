            ...
            <div class="col-12 col-md-8">
                ...
                <form id="my-form" class="p-5 text-white" action="{{route('game.update',compact('game'))}}" method="POST" enctype="multipart/form-data"> 
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="title" id="title" value="{{old('title', $game->title)}}">
                    </div>
                    <div class="mb-3">
                        <label for="price" class="form-label">Price:</label>
                        <input type="number" step="0.01" class="form-control" name="price" id="price" value="{{old('price', $game->price)}}">
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="consoles">Boss of the game:</label>
                        <select name="consoles[]" id="consoles" multiple class="form-control overflow-hidden">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="description" id="description" rows="4">{{old('description', $game->description)}}</textarea>
                    </div>
                </form>
